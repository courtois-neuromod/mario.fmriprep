...
#SBATCH --job-name=fmriprep_study-cneuromod.mario_sub-02_ses-018.job
#SBATCH --output=/lustre04/scratch/bpinsard/mario.fmriprep/code/fmriprep_study-cneuromod.mario_sub-02_ses-018.out
#SBATCH --error=/lustre04/scratch/bpinsard/mario.fmriprep/code/fmriprep_study-cneuromod.mario_sub-02_ses-018.err
#SBATCH --time=8:00:00
...
if [ -e $LOCAL_DATASET/workdir/fmriprep_wf/resource_monitor.json ] ; then cp $LOCAL_DATASET/workdir/fmriprep_wf/resource_monitor.json /scratch/bpinsard/fmriprep_study-cneuromod.mario_sub-02_ses-018_resource_monitor.json ; fi 
if [ $fmriprep_exitcode -ne 0 ] ; then cp -R $LOCAL_DATASET /scratch/bpinsard/fmriprep_study-cneuromod.mario_sub-02_ses-018 ; fi 
