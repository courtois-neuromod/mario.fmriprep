...
#SBATCH --job-name=fmriprep_study-cneuromod.mario_sub-06_ses-025.job
#SBATCH --output=/lustre04/scratch/bpinsard/mario.fmriprep/code/fmriprep_study-cneuromod.mario_sub-06_ses-025.out
#SBATCH --error=/lustre04/scratch/bpinsard/mario.fmriprep/code/fmriprep_study-cneuromod.mario_sub-06_ses-025.err
#SBATCH --time=8:00:00
...
if [ -e $LOCAL_DATASET/workdir/fmriprep_wf/resource_monitor.json ] ; then cp $LOCAL_DATASET/workdir/fmriprep_wf/resource_monitor.json /scratch/bpinsard/fmriprep_study-cneuromod.mario_sub-06_ses-025_resource_monitor.json ; fi 
if [ $fmriprep_exitcode -ne 0 ] ; then cp -R $LOCAL_DATASET /scratch/bpinsard/fmriprep_study-cneuromod.mario_sub-06_ses-025 ; fi 
